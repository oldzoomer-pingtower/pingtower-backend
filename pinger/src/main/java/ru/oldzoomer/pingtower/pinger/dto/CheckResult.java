...
@Data
@Schema(description = "Результат проверки доступности ресурса")
public class CheckResult {
    ...
    @Schema(description = "Статус проверки", example = "SUCCESS", allowableValues = {"SUCCESS", "FAILURE", "TIMEOUT", "ERROR"})
    ...
    @Data
    @Schema(description = "Метрики проверки доступности")
    public static class Metrics {
        @Schema(description = "Время установления соединения в миллисекундах", example = "50")
